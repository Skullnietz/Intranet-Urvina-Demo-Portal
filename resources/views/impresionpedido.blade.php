...
<head>
    ...
    <title>USI | Impresion del pedido generado</title>
    <!-- CSRF Token -->
...
<body>
    <div class="container">
        <div  class="row">
                ...
                <div class="border rounded" style="width:500px; height:130px"><br>
                    <table style="width:500px;" >
                        <tr style="height:20px;" >
                            <td class=" border-top border-bottom">&nbsp;&nbsp;&nbsp;<b>Planta</b> </td>
            ...
            <div class="col-3" style="width:280px; height:200px; margin-top:-24px"><br>
                <div class="border-top border-right border-bottom rounded" style="padding:10px; text-align:center">
                    <label style="width:230px;height:22px;margin-left:-15px"for=""><b>Pedido No.</b> </label><br>
        ...
        <br>
        <div class="row">
            <div class="col-2 border rounded" style="text-align:center"><b> Artículo </b></div>
            <div class="col-2 border rounded" style="text-align:center"><b> Código </b></div>
            <div class="col-7 border rounded" style="text-align:center"><b> Descripción </b></div>
        ...
        <div class="row">
            ...
            <div class="col-2 border rounded" style="text-align:right"><b>Impuesto: $5.47</b></div>
            <div class="col-2 border rounded" style="text-align:right"><b>Total: $39.63</b></div>
