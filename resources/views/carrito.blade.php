...
<div class="container">
    <div class="row">
        <div class="col-6"><h1>Carrito</h1></div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-4"><a href="" style="float:right" class="btn btn-lg btn-primary"
                    data-toggle="modal" data-target="#exampleModal"> Continuar con la compra</a></div>
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" for="inputGroupSelect01"><i
                                                    class="fas fa-chart-area"></i>&nbsp;| Departamento</label>
                                        </div>
                        ...
                        <div class="row">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <label class="input-group-text" for="inputGroupSelect01"><i
                                            class="fas fa-users-cog"></i>&nbsp;| Equipo/Trabajo</label>
                                </div>
                                <select class="custom-select" id="inputGroupSelect01">
                        ...
                        <div class="row">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <label class="input-group-text" for="inputGroupSelect01"><i
                                            class="fas fa-truck"></i>&nbsp;| Envio</label>
                                </div>
